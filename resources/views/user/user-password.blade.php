...
<div class="container">
    <div class="row">
        <div class="col-sm-2 offset-1 left-section mt-5 border-right">
            <h6><a href="{{ route('users.edit', ['id' => $user->id]) }}" class="text-decoration-none font-weight-bold text-info">Account</a></h6>
            <h6><a href="{{ route('passwords.edit', ['id' => $user->id]) }}" class="text-decoration-none font-weight-bold text-info">Password</a></h6>
        </div>

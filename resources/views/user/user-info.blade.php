            ...
            <form>
                ...
                <div class="col-s12 edit-info mt-2">
                    <div class="form-group">
                        <label for="user_name" class="font-weight-bold">{{ __('user-info.user_name') }}</label>
                        <input type="text" class="form-control" id="user_name" placeholder="Old name">
                    </div>
                    <div class="form-group">
                        <label for="nickname" class="font-weight-bold">{{ __('user-info.nick_name') }}</label>
                        <input type="text" class="form-control" id="nickname" placeholder="Old nick name">
                    </div>
                    <div class="form-group">
                        <label for="email" class="font-weight-bold">{{ __('user-info.email') }}</label>
                        <input type="email" class="form-control" id="email" placeholder="Old email">
                    </div>
